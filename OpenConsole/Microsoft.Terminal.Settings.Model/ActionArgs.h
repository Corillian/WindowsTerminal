...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    public:
        ...
        bool DeepEquals(const Model::NewTerminalArgs& other)
        {
    ...
    public:
        ...
        bool Equals(const IActionArgs& other)
        {
            ...
            if (otherAsUs)
            {
                return otherAsUs->_TerminalArgs.DeepEquals(_TerminalArgs);
            }
            return false;
        };
        static FromJsonResult FromJson(const Json::Value& json)
        ...
        bool Equals(const IActionArgs& other)
        {
            ...
            if (otherAsUs)
            {
                return otherAsUs->_SplitStyle == _SplitStyle &&
                       (otherAsUs->_TerminalArgs ? otherAsUs->_TerminalArgs.DeepEquals(_TerminalArgs) :
