...
namespace winrt::Microsoft::Terminal::Control::implementation
{
        ...
        const bool pointerPressedInBounds)
    {
        ...
        _core->SetHoveredCell({ static_cast<int32_t>(terminalPosition.x()), static_cast<int32_t>(terminalPosition.y()) });
    }
        ...
        Control::MouseButtonState buttonState)
    {
        ...
        {
            return _core->SendMouseEvent({ terminalPosition.x(), adjustedY }, pointerUpdateKind, *reinterpret_cast<winrt::Microsoft::Terminal::Core::ControlKeyStates const*>(&modifiers), wheelDelta, toInternalMouseState(buttonState));
        }
        return false;
    }
