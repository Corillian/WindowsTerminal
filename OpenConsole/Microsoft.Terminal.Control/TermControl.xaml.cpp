...
namespace winrt::Microsoft::Terminal::Control::implementation
{
        ...
        Input::CharacterReceivedRoutedEventArgs const& e)
    {
        ...
        const bool handled = _core.SendCharEvent(ch, scanCode, *reinterpret_cast<winrt::Microsoft::Terminal::Core::ControlKeyStates*>(&modifiers));
        e.Handled(handled);
    }
        ...
        const bool rightButtonDown)
    {
        ...
        return _interactivity.MouseWheel(*reinterpret_cast<winrt::Microsoft::Terminal::Core::ControlKeyStates const*>(&modifiers), delta, _toTerminalOrigin(location), state);
    }
