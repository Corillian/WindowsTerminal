...
namespace winrt::Microsoft::Terminal::Control::implementation
{
    ...
    {
        return _terminal->SendCharEvent(ch, scanCode, *reinterpret_cast<::Microsoft::Terminal::Core::ControlKeyStates const*>(&modifiers));
    }
                                      ...
                                      const bool keyDown)
    {
            ...
            keyDown)
        {
            ...
            if (!reinterpret_cast<::Microsoft::Terminal::Core::ControlKeyStates const*>(&modifiers)->IsWinPressed())
            {
    ...
    {
        return _terminal->SendMouseEvent(viewportPos, uiButton, *reinterpret_cast<::Microsoft::Terminal::Core::ControlKeyStates const*>(&states), wheelDelta, state);
    }
    ...
    {
        return _lastHoveredCell.has_value() ? Windows::Foundation::IReference<Core::Point>{ toTerminalPoint(_lastHoveredCell.value()) } : nullptr;
    }
    ...
    winrt::Microsoft::Terminal::Core::Color ControlCore::BackgroundColor() const
    {
        const til::color clr = _terminal->GetDefaultBackground();
    ...
    Core::Point ControlCore::CursorPosition() const
    {
        ...
        auto lock = _terminal->LockForReading();
        const auto pt = _terminal->GetCursorPosition();
